...
current_cpf = re.sub(r'[^0-9]', '', user_request_cpf)

sequencial_input = user_request_cpf == user_request_cpf[0] * len(user_request_cpf)
...
calculate_cpf = f'{current_cpf[:9]}{first_digit}{second_digit}'

if calculate_cpf == current_cpf:
    print(f'{calculate_cpf} é valido!')
else:
    print('CPF INVALIDO')